...
BreakpointStore.prototype = {
   ...
   *        The breakpoint to be added. It is an object with the following
   *        properties:
   *          - url
   *          - line
  ...
  _iterLines: function BS__iterLines(aUrl, aLine) {
    if (aLine != null) {
      ...
      const lines = Object.keys(this._wholeLineBreakpoints[aUrl])
        .concat(Object.keys(this._breakpoints[aUrl]))
        .sort();
