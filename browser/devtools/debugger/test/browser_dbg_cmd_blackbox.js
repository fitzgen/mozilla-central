...
function cmd(typed) {
  ...
  gThreadClient.addOneTimeListener("blackboxchange", deferred.resolve);
...
function testBlackBoxGlob() {
  return cmd("dbg blackbox --glob *blackbox_t*.js")
    .then(function () {
...
function testUnBlackBoxGlob() {
  return cmd("dbg unblackbox --glob *blackbox_t*.js")
    .then(function () {
      ok(getBlackBoxCheckbox(BLACKBOXTWO_URL).checked,
